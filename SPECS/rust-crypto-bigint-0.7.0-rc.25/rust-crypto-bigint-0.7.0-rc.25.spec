...
%global full_version 0.7.0-rc.25
%global pkgname crypto-bigint-0.7.0-rc.25

Name:           rust-crypto-bigint-0.7.0-rc.25
Version:        0.7.0
Release:        %autorelease
Summary:        Rust crate "crypto-bigint"
License:        Apache-2.0 OR MIT
URL:            https://github.com/RustCrypto/crypto-bigint
#!RemoteAsset:  sha256:cba9eeeb213f7fd29353032f71f7c173e5f6d95d85151cb3a47197b0ea7e8be7
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(der-0.8.0-rc.10) >= 0.8.0-rc.10
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(hybrid-array-0.4/default) >= 0.4.6
...
Requires:       crate(hybrid-array-0.4/subtle) >= 0.4.6
