...
# warning: comparison between two arrays is deprecated in C++20
Patch0:         0001-Fix-pod-operator_-for-array-members.patch
# python-libclang is really old.
Patch2000:      2000-Use-system-python-clang.patch
# Drop this after mupdf support llvm >21
Patch2001:      2001-scripts-wrap-resolve-forward-declarations-before-ins.patch
...
# TODO: provide a general python-clang package in the future.
BuildRequires:  python3-clang22
...
echo > user.make "\
	...
	shared := yes
	verbose := yes
	export LIBCLANG_LIBRARY_FILE=%{clang_resource_dir}/../../libclang.so
	export PYTHONPATH := %{clang_resource_dir}/../../python%{python3_version}/site-packages
"
...
%build -a
export PYTHONPATH=%{clang_resource_dir}/../../python%{python3_version}/site-packages${PYTHONPATH:+:$PYTHONPATH}
export LIBCLANG_LIBRARY_FILE=%{clang_resource_dir}/../../libclang.so
# C++ wrapper sources were already generated by `make ... c++`.
