...
%global full_version 0.8.0-rc.9
%global pkgname der-0.8.0-rc.9

Name:           rust-der-0.8.0-rc.9
Version:        0.8.0
Release:        %autorelease
Summary:        Rust crate "der"
License:        Apache-2.0 OR MIT
URL:            https://github.com/RustCrypto/formats/tree/master/der
#!RemoteAsset:  sha256:e9d8dd2f26c86b27a2a8ea2767ec7f9df7a89516e4794e54ac01ee618dda3aa4
...
Provides:       crate(%{pkgname}/ber) = %{version}
...
Requires:       crate(const-oid-0.10/arbitrary) >= 0.10.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(der-derive-0.8.0-rc.5/default) >= 0.8.0-rc.5
...
Summary:        Pure Rust embedded-friendly implementation of the Distinguished Encoding Rules (DER) for Abstract Syntax Notation One (ASN.1) as described in ITU X.690 with full support for heapless no_std targets - feature "heapless"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(heapless-0.8) >= 0.8.0
...
Requires:       crate(pem-rfc7468-1.0.0-rc.3/alloc) >= 1.0.0-rc.3
Requires:       crate(pem-rfc7468-1.0.0-rc.3/default) >= 1.0.0-rc.3
