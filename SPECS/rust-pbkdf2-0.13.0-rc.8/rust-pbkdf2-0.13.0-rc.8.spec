...
%global full_version 0.13.0-rc.8
%global pkgname pbkdf2-0.13.0-rc.8

Name:           rust-pbkdf2-0.13.0-rc.8
Version:        0.13.0
Release:        %autorelease
Summary:        Rust crate "pbkdf2"
License:        MIT OR Apache-2.0
URL:            https://github.com/RustCrypto/password-hashes/tree/master/pbkdf2
#!RemoteAsset:  sha256:626220f48328b90cad8393e99e9ef80503970e6e86e77f32f7e42227972e7c2c
...
Requires:       crate(mcf-0.6.0-rc.3/alloc) >= 0.6.0-rc.3
Requires:       crate(mcf-0.6.0-rc.3/base64) >= 0.6.0-rc.3
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(hmac-0.13.0-rc.3) >= 0.13.0-rc.3
...
Requires:       crate(sha1-0.11.0-rc.3) >= 0.11.0-rc.3
