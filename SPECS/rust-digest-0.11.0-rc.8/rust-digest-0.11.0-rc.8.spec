...
%global full_version 0.11.0-rc.8
%global pkgname digest-0.11.0-rc.8

Name:           rust-digest-0.11.0-rc.8
Version:        0.11.0
Release:        %autorelease
Summary:        Rust crate "digest"
License:        MIT OR Apache-2.0
URL:            https://github.com/RustCrypto/traits
#!RemoteAsset:  sha256:2fc1408b7a9f59a7b933faff3e9e7fc15a05a524effd3b3d1601156944c8077f
...
Requires:       crate(crypto-common-0.2.0-rc.13/default) >= 0.2.0-rc.13
...
Requires:       crate(crypto-common-0.2.0-rc.13/getrandom) >= 0.2.0-rc.13
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(crypto-common-0.2.0-rc.13/rand-core) >= 0.2.0-rc.13
