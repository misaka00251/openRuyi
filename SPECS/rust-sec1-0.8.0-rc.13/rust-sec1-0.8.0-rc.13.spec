...
%global pkgname sec1-0.8.0-rc.13

Name:           rust-sec1-0.8.0-rc.13
Version:        0.8.0
Release:        %autorelease
Summary:        Rust crate "sec1"
License:        Apache-2.0 OR MIT
URL:            https://github.com/RustCrypto/formats/tree/master/sec1
#!RemoteAsset:  sha256:7a2400ed44a13193820aa528a19f376c3843141a8ce96ff34b11104cc79763f2
...
Requires:       crate(der-0.8.0-rc.10/alloc) >= 0.8.0-rc.10
...
Summary:        Pure Rust implementation of SEC1: Elliptic Curve Cryptography encoding formats including ASN.1 DER-serialized private keys as well as the Elliptic-Curve-Point-to-Octet-String encoding - feature "ctutils"
Requires:       crate(%{pkgname}) = %{version}
...
Requires:       crate(der-0.8.0-rc.10/oid) >= 0.8.0-rc.10
Requires:       crate(der-0.8.0-rc.10/pem) >= 0.8.0-rc.10
...
Requires:       crate(%{pkgname}/alloc) = %{version}
Requires:       crate(der-0.8.0-rc.10/oid) >= 0.8.0-rc.10
Requires:       crate(der-0.8.0-rc.10/std) >= 0.8.0-rc.10
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(der-0.8.0-rc.10/oid) >= 0.8.0-rc.10
Requires:       crate(der-0.8.0-rc.10/zeroize) >= 0.8.0-rc.10
