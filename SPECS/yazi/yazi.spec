...
BuildRequires:  crate(ratatui-termina-0.1) >= 0.1.0
# Use our jemalloc instead of vendored one for rva23
...
# We need these shell completions to be generated during build
